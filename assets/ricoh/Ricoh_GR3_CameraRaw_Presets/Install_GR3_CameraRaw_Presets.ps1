# Installs the GR3 Camera Raw presets for the current Windows user.
# Run: powershell -ExecutionPolicy Bypass -File .\Install_GR3_CameraRaw_Presets.ps1
...
Write-Output ""
Write-Output "Restart Photoshop or Camera Raw, then open the Presets panel and find 'GR3 Camera Raw Looks'."