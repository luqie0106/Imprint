...
<template>
  <div class="h-full flex flex-col gap-5 p-6 overflow-y-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <input
            ...
            class="px-3.5 py-2 rounded-xl border border-zinc-300 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/70 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
          />
          <div class="text-[11px] text-zinc-600 dark:text-zinc-400 leading-relaxed space-y-0.5 mt-0.5 bg-zinc-50 dark:bg-zinc-950/60 p-2.5 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80">
            <div>• <span class="text-zinc-800 dark:text-zinc-200 font-medium">6 ~ 8</span>：定点摆拍（要求构图严格一致）</div>
            <div>• <span class="text-indigo-600 dark:text-indigo-400 font-medium">12</span>：常规手持 / 追焦（默认推荐）</div>
            <div>• <span class="text-zinc-800 dark:text-zinc-200 font-medium">16 ~ 20</span>：大幅甩镜头 / 奔跑运动抓拍</div>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <input
            ...
            :class="
              isWorkersExceeded
                ? 'border-rose-500 text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/50 ring-2 ring-rose-500/20'
                : 'border-zinc-300 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/70 text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-indigo-500/40'
            "
          />
    ...
    <div
      ...
      class="bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl p-5 border border-emerald-200 dark:border-emerald-800/60 flex flex-col gap-3 shadow-xs animate-fade-in"
    >
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm mt-1">
        <div class="bg-white/80 dark:bg-zinc-900/60 border border-emerald-100 dark:border-zinc-800/60 p-3 rounded-xl shadow-2xs">
